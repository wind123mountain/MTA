...
OUTPUT_DIR="${BASE_PATH}/eval_outputs/${MODEL_PATH}-span-distillm2-checkpoint-v2-4287"
...
OPTS+=" --lora_path distillm-2-master/outputs/opt-1.3b-span-distillm2-v2/checkpoint-4287"
